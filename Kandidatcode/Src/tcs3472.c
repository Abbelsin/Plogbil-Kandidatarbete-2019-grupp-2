...
HAL_StatusTypeDef TCS3472_readColor(TCS3472* tcs3472, TCS3472_Color* colorData) {
  (_TCS3472_read16bitReg(tcs3472, TCS3472_ADDR_CDATAL, &colorData->c));
  (_TCS3472_read16bitReg(tcs3472, TCS3472_ADDR_RDATAL, &colorData->r));
  (_TCS3472_read16bitReg(tcs3472, TCS3472_ADDR_GDATAL, &colorData->g));
  (_TCS3472_read16bitReg(tcs3472, TCS3472_ADDR_BDATAL, &colorData->b));
  return HAL_OK;
}
